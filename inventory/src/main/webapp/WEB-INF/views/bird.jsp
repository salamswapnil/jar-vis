...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			successAlert();
			getAllBirdNames();
			$('#addBirdsFrm').submit(function(event){
			...
			$('#ddlbirdnames').change(function(event){
				if(this.selectedIndex > 0)
					generateBatchNo('ddlbirdnames');
				else{
	...
	<div class="container">  
		<form:form action="${pageContext.request.contextPath}/addBirdDetails" method="post" commandName="birdObject">
			<div class="row margin-bottom-inputs margin-top-inputs">
				<div class="col-md-2">
					<label>Available Birds</label>
				</div>
				<div class="col-md-4">
					<form:select path="birdName" class="form-control" name="ddlBirds" id="ddlbirdnames" required="required">
					</form:select>
				</div>
				<div class="col-md-2">
					<!-- <div id="AddFishCatg">Add fish Species</div> -->
					<a class="btn" data-popup-open="popup-1" href="#">Add Bird Names</a>
				</div>
			</div>
	...
	<div class="popup" data-popup="popup-1">
		<div class="popup-inner">
			...
			<div id="addBirdsFrm" class="container" style="position: absolute;top:30%;margin-top:10px;">
			  <form action="${pageContext.request.contextPath}/addBirdName" method="post">
			  	
			  	<div class="row" style="margin-bottom: 20px;">
			  		<div class="col-md-10">
			  			<input id="txtbirdname" name="birdname" class="form-control" placeholder="Bird Name" type="text" required/>
			  		</div>
			  	</div>
			    <div class="row margin-bottom-inputs">
